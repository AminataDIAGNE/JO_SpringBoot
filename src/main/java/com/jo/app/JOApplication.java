...
public class JOApplication implements CommandLineRunner{
	...
	public static void main(String[] args) {
		SpringApplication.run(com.jo.app.JOApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
        ...
        Role role1 = new Role();
        role1.setName(Roles.CONTROLEUR.getLibelle());
        Role role2 = new Role();
        role2.setName(Roles.ORGANISATEUR.getLibelle());
        Role role3= new Role();
        role3.setName(Roles.SPECTATEUR.getLibelle());
        Role role4= new Role();
        role4.setName(Roles.PARTICIPANT.getLibelle());
